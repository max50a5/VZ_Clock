...
<html>
    <head>
        ...
        <title>Часы-метеостанция VZ_Clock_x1.M_v4.1 (by IvanZah)</title>
        ...
        <script type = "text/javascript">
            ...
            function set_weather(submit) {
                ...
                server += "&displayForecast=" + val_sw('displayForecast') + "&displayCityName=" + val_sw('displayCityName') + "&displayForecastNow=" + val_sw('displayForecastNow') + "&displayForecastToday=" + val_sw('displayForecastToday') + "&displayForecastTomorrow=" + val_sw('displayForecastTomorrow') + "&timeScrollStart=" + val('timeScrollStart') + "&timeScrollStop=" + val('timeScrollStop') + "&timeScrollSpeed=" + val('timeScrollSpeed');
    ...
    <body onload = "load_weath();">
        <header>
            <span class="opt_cn">Часы-метеостанция VZ_Clock_x1.M_v4.1 (by IvanZah)</span><br>
        ...
        <central-unit>
            ...
            <div id="main_unit">
                    ...
                    <br>
                     <label class="switch"><span class="opt_cn">Показывать прогноз на сегодня (Да/Нет)</span>
