    ...
    <body onload = "load_wifi();">
        ...
        <central-unit>
            ...
            <div class="body__center">
                ...
                <div id="main_unit">
                    <paragraph>
                        <span class="opt_cn">Подключение к WiFi-сети</span>
                    </paragraph>
                    <center>
                        <table>
                            <tr>
                                <td align = "right"><span class="opt_cn">Название WiFi-сети</span></td>
                                <td><input type="text" class="field form-control" id="ssid" value="{{ssid}}" pattern="[-\w\s#@/]{1,15}" placeholder="название WiFi-сети"></td>
                            </tr>
                            <tr>  
                                <td align = "right"><span class="opt_cn">Пароль WiFi-сети</span></td>
                    ...
                    <center>
                        <table>
                            <tr>
                                <td align = "right"><span class="opt_cn">Название точки доступа</span></td>
                            ...
                            <tr>
                                <td align = "right"><span class="opt_cn">Пароль точки доступа</span></td>  
