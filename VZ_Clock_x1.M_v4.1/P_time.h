...
<html>
    ...
    <body onload = "load_times();">
        ...
        <central-unit>
            ...
            <div id="main_unit">
                <paragraph><span class="opt_cn">Сервер точного времени, например, "time.nist.gov"</span></paragraph>
                ...
                <span class="opt_cn">Часовой пояс</span>
                <select id = "timeZone">
                ...
                <br>
                <br>
                <paragraph><span class="opt_cn">Настройки будильников</span></paragraph>
                <center>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="al_0_2">
                                    ...
                                    <option value="11">Один раз</option>
                                    <option value="8">Пн-Пт</option>
                                    <option value="9">Пн-Сб</option>
                                    <option value="10">Сб-Вс</option>
                ...
                <br>
                <span class="save_booton" onclick="set_ntp_auto(this);">Установить время и дату с ПК</span>
            </div>
            <div>
