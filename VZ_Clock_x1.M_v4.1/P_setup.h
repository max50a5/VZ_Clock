        ...
        <central-unit>
            ...
            <div id="main_unit">
                <center>
                    ...
                    <label class="switch"><span class="opt_cn">Автоматический уровень яркости (Да/Нет)</span>
                    ...
                    <table>
                        ...
                        <tr>
                            <td align = "right"><span class="opt_cn">Показывать дату</span></td>
                            <td><select id = "displayData">
                                <option value = "0"> Отключенно </option>
                                <option value = "1"> Статично </option>
                                <option value = "2"> Строкой </option>
                            </select></td>
                        </tr>
                    </table>
                    <label class="switch"><span class="opt_cn">В ночное время показывать только часы (Да/Нет)</span>
